...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Full Name with 'No Email', fill Password with 'ValidPass123!', then click the 'Continue — Choose Plan' submit button to trigger validation.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/div/div/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('No Email')
