...
export default function OnboardingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (nativeLang === targetLang) {
      toast.error("Native and Target languages cannot be the same.");
      return;
    }
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg z-10 glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl bg-gray-900/50 backdrop-blur-xl">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent mb-3">Set Up Your Profile</h1>
          <p className="text-gray-400 text-sm">Choose the language you speak and the one you want to learn.</p>
        </div>
