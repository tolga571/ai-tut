...
const plans: Plan[] = [
  {
    ...
    features: ["Basic Language Practice", "100 AI Messages/day", "All Languages"],
  },
  {
    id: "standard-yearly",
    ...
    features: ["Basic Language Practice", "100 AI Messages/day", "All Languages", "Save 10%"],
  },
  {
    id: "pro-monthly",
    name: "Pro Monthly",
    price: "$29", // Estimated based on typical pricing, but using fetched IDs
    period: "/month",
    priceId: process.env.NEXT_PUBLIC_PADDLE_PRICE_PRO_MONTHLY || "",
    features: ["Advanced Practice", "Unlimited Messages", "Personalized Tutors", "Priority Support"],
    recommended: true,
  },
  {
    id: "pro-yearly",
    ...
    features: ["Advanced Practice", "Unlimited Messages", "Personalized Tutors", "Save 20%"],
  },
];
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-12 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg">Select the plan that fits your learning journey</p>
      </div>
